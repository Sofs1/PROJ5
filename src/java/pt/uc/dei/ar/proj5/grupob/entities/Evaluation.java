...
@NamedQueries({
    ...
    // @NamedQuery(name = "Evaluation.noteStudProjCrit", query = "SELECT u.note FROM Evaluation u WHERE u.project.id = :id_proj, u.criteria.id :id_crit and u.student.id = :id_st"),
    ...
    @NamedQuery(name = "Evaluation.avgAdminAnsAllStudByPaj", query = "SELECT AVG(u.note), u.student.name FROM Evaluation u WHERE u.project.paj = :paj group by u.student.name"),
    ...
    @NamedQuery(name = "Evaluation.avgAdminAllStudsEachCrit", query = "SELECT AVG(u.note), u.criteria.description FROM Evaluation u WHERE u.criteria.paj = :paj group by u.criteria.description"),
    @NamedQuery(name = "Evaluation.avgAdminEachPajEdi", query = "SELECT AVG(u.note), u.project.paj.name FROM Evaluation u group by u.project.paj.name"),
    @NamedQuery(name = "Evaluation.avgAdminAllAnsByProj", query = "SELECT AVG(u.note), u.project.name FROM Evaluation u WHERE u.project.paj = :paj group by u.project.name"),
